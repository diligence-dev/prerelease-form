...
var translations = map[string]map[string]string{
	"en": {
		...
		"cash_info":        "You can pay cash on site. However, we'd appreciate payment in advance via Wero or IBAN.",
		...
		"pay_later_note":   "If you actually have not paid yet, you can do so now:",
		"look_forward":     "We look forward to seeing you at the event!",
		"pay_later_info":   "You'll find the payment link in your confirmation email. You can pay anytime before the event starts.",
...
`,
	...
	"de": {
		...
		"cash_info":        "Du kannst vor Ort in bar zahlen. Wir würden uns jedoch freuen wenn du im Voraus per Wero oder IBAN bezahlst.",
		...
		"pay_later_note":   "Falls du noch nicht bezahlt hast, kannst du das jetzt tun:",
		"look_forward":     "Wir freuen uns, dich bei der Veranstaltung zu sehen!",
		"pay_later_info":   "Den Zahlungslink findest du in deiner Bestätigungsmail. Du kannst jederzeit vor Eventbeginn bezahlen.",
